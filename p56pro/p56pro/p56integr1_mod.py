    ...
    try:
        ...
        with open(image_path, 'rb') as file:
            ...
            if response.status_code == 200:
                ...
                print("ocr result :::::::::::::: ", parsed_text, "the end::::::")
            else:
...
def get_ingredients_advice(healthcondition, ingredients):
    ...
    if ingredients!='':
        ...
        r = advice_text(healthcondition,list, 'en' )
        #print(r)
        return r.replace('\'','').replace('"', '\'')

def p56query(image_path, healthcondition):
    parsed_text=get_ocr_text(image_path)
    advice=''
    if parsed_text!='':
        ingredients = parsed_text        
        advice = get_ingredients_advice(healthcondition, ingredients)

    return [parsed_text, advice]
if __name__=='__main__':
    # pass 
    image_path = r'C:\Users\T480\p56_1.jpg'
    ...
    result = p56query(image_path, healthcondition)
    print(result)
